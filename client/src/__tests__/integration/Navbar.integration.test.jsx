...
describe('Navbar Integration Tests', () => {
  ...
  it('"New Arrivals" pill links to /collections', () => {
    renderNavbar();
    expect(screen.getByRole('link', { name: /new arrivals/i })).toHaveAttribute('href', '/collections');
  });

  it('"Sales" pill links to /collections', () => {
    renderNavbar();
    expect(screen.getByRole('link', { name: /sales/i })).toHaveAttribute('href', '/collections');
  });
